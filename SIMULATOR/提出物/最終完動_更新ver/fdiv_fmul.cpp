...
//     in_data(filename);
//     float x_1, x_2;
//     x_1 = -pow(2, 126); x_2 = -pow(2, 126);
    // while(1){
    //     x_1 += pow(2, 110);
    //     if(x_1 > pow(2, 126)) {cout << "i " << x_1<<endl; break;}
    //     while(1){
    //         x_2 += pow(2, 120);
    //         if(x_2 == 0) continue;
    //         if(x_2 > pow(2, 125)) break;
    //         if(abs(x_1 / x_2) > pow(2, 127)) continue;
    //         Bit32 y = fdiv(f_to_bit(x_1), f_to_bit(x_2));
    ...
    //         // }
    //         float max = f_max(abs(x_1/x_2)*pow(2,-20), pow(2,-126));
    //         // cout << diff << " " << max << endl;
    //         if(diff > max){
    //             cout << "No" << f_y << " " << ans << endl;
    //             cout << x_1 << " " << x_2 << endl;
    //         }else{
    //             cout << "Yes" << f_y << " " << ans << endl;
    //         }
    //     }
    // }
//     // x_1 = 1.64; //44fa21b3
