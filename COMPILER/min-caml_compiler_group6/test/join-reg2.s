...
bge_cont.393: #pc 244
	...
	j	be_else.394 #pc 308
	nop #pc 312
	j	be_cont.395 #pc 316
	nop #pc 320
be_else.394: #pc 324
...
be_cont.395: #pc 328
	...
	j	bge_else.396 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.397 #pc 372
	nop #pc 376
bge_else.396: #pc 380
...
bge_cont.397: #pc 384
	...
	j	be_else.398 #pc 444
	nop #pc 448
	j	be_cont.399 #pc 452
	nop #pc 456
be_else.398: #pc 460
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 789  #0 pc 556
	sw	%x1, 0(%x2)  #212 pc 560
	addi	%x2, %x2, 4  #212 pc 564
	jal	%x1, print_int.179  #212 pc 568
