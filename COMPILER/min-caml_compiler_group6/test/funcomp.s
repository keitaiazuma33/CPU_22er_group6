...
bge_cont.405: #pc 244
	...
	j	be_else.406 #pc 308
	nop #pc 312
	j	be_cont.407 #pc 316
	nop #pc 320
be_else.406: #pc 324
...
be_cont.407: #pc 328
	...
	j	bge_else.408 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.409 #pc 372
	nop #pc 376
bge_else.408: #pc 380
...
bge_cont.409: #pc 384
	...
	j	be_else.410 #pc 444
	nop #pc 448
	j	be_cont.411 #pc 452
	nop #pc 456
be_else.410: #pc 460
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 247  #0 pc 556
	sw	%x1, 0(%x2)  #214 pc 560
	addi	%x2, %x2, 4  #214 pc 564
	jal	%x1, print_int.174  #214 pc 568
	addi	%x2, %x2, -4  #214 pc 572
	lw	%x1, 0(%x2) #214 pc 576
