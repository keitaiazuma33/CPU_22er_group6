...
bge_cont.399: #pc 244
	...
	j	be_else.400 #pc 308
	nop #pc 312
	j	be_cont.401 #pc 316
	nop #pc 320
be_else.400: #pc 324
...
be_cont.401: #pc 328
	...
	j	bge_else.402 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.403 #pc 372
	nop #pc 376
bge_else.402: #pc 380
...
bge_cont.403: #pc 384
	...
	j	be_else.404 #pc 444
	nop #pc 448
	j	be_cont.405 #pc 452
	nop #pc 456
be_else.404: #pc 460
...
bge_else.396: #pc 512
	...
	nop #pc 532
ack.202:  #pc 536
	bge	%x0, %x6, 12  #208 pc 536
	j	ble_else.408 #pc 540
	nop #pc 544
	addi	%x6, %x7, 1  #208 pc 548
	ret #pc 552
	nop #pc 556
ble_else.408: #pc 560
	bge	%x0, %x7, 12  #209 pc 560
	j	ble_else.409 #pc 564
	nop #pc 568
	addi	%x6, %x6, -1  #209 pc 572
	addi	%x7, %x0, 1  #0 pc 576
	j	ack.202  #209 pc 580
	nop #pc 584
ble_else.409: #pc 588
	addi	%x8, %x6, -1  #210 pc 588
	addi	%x7, %x7, -1  #210 pc 592
	sw	%x8, 0(%x2)  #210 pc 596
	sw	%x1, 4(%x2)  #210 pc 600
	addi	%x2, %x2, 8  #210 pc 604
	jal	%x1, ack.202  #210 pc 608
	addi	%x2, %x2, -8  #210 pc 612
	lw	%x1, 4(%x2) #210 pc 616
	addi	%x7, %x6, 0  #210 pc 620
	lw	%x6, 0(%x2)  #210 pc 624
	j	ack.202  #210 pc 628
	nop #pc 632
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 3  #0 pc 656
	addi	%x7, %x0, 10  #0 pc 660
	sw	%x1, 0(%x2)  #211 pc 664
	addi	%x2, %x2, 4  #211 pc 668
	jal	%x1, ack.202  #211 pc 672
	addi	%x2, %x2, -4  #211 pc 676
	lw	%x1, 0(%x2) #211 pc 680
	sw	%x1, 0(%x2)  #211 pc 684
	addi	%x2, %x2, 4  #211 pc 688
	jal	%x1, print_int.182  #211 pc 692
	addi	%x2, %x2, -4  #211 pc 696
	lw	%x1, 0(%x2) #211 pc 700
