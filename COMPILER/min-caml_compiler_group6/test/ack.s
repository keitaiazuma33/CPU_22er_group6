...
ack.202:  #pc 672
	...
	j	ble_else.390 #pc 676
	nop #pc 680
	addi	%x6, %x7, 1  #208 pc 684
	ret #pc 688
	nop #pc 692
ble_else.390: #pc 696
	bge	%x0, %x7, 12  #209 pc 696
	j	ble_else.391 #pc 700
	nop #pc 704
	addi	%x6, %x6, -1  #209 pc 708
	addi	%x7, %x0, 1  #0 pc 712
	j	ack.202  #209 pc 716
	nop #pc 720
ble_else.391: #pc 724
	addi	%x8, %x6, -1  #210 pc 724
	addi	%x7, %x7, -1  #210 pc 728
	sw	%x8, 0(%x2)  #210 pc 732
	sw	%x1, 4(%x2)  #210 pc 736
	addi	%x2, %x2, 8  #210 pc 740
	jal	%x1, ack.202  #210 pc 744
	addi	%x2, %x2, -8  #210 pc 748
	lw	%x1, 4(%x2) #210 pc 752
	addi	%x7, %x6, 0  #210 pc 756
	lw	%x6, 0(%x2)  #210 pc 760
	j	ack.202  #210 pc 764
	nop #pc 768
...
min_caml_start:
	...
	addi	%x4, %x0, 8192
	addi	%x5, %x0, 65536
	addi	%x6, %x0, 3  #0 pc 788
	addi	%x7, %x0, 10  #0 pc 792
	sw	%x1, 0(%x2)  #211 pc 796
	addi	%x2, %x2, 4  #211 pc 800
	jal	%x1, ack.202  #211 pc 804
	addi	%x2, %x2, -4  #211 pc 808
	lw	%x1, 0(%x2) #211 pc 812
	sw	%x1, 0(%x2)  #211 pc 816
	addi	%x2, %x2, 4  #211 pc 820
	jal	%x1, print_int.182  #211 pc 824
	addi	%x2, %x2, -4  #211 pc 828
	lw	%x1, 0(%x2) #211 pc 832
