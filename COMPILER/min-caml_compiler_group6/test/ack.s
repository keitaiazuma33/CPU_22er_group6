...
bge_else.386: #pc 656
	...
	nop #pc 676
ack.202:  #pc 680
	bge	%x0, %x6, 12  #208 pc 680
	j	ble_else.390 #pc 684
	nop #pc 688
	addi	%x6, %x7, 1  #208 pc 692
	ret #pc 696
	nop #pc 700
ble_else.390: #pc 704
	bge	%x0, %x7, 12  #209 pc 704
	j	ble_else.391 #pc 708
	nop #pc 712
	addi	%x6, %x6, -1  #209 pc 716
	addi	%x7, %x0, 1  #0 pc 720
	j	ack.202  #209 pc 724
	nop #pc 728
ble_else.391: #pc 732
	addi	%x8, %x6, -1  #210 pc 732
	addi	%x7, %x7, -1  #210 pc 736
	sw	%x8, 0(%x2)  #210 pc 740
	sw	%x1, 4(%x2)  #210 pc 744
	addi	%x2, %x2, 8  #210 pc 748
	jal	%x1, ack.202  #210 pc 752
	addi	%x2, %x2, -8  #210 pc 756
	lw	%x1, 4(%x2) #210 pc 760
	addi	%x7, %x6, 0  #210 pc 764
	lw	%x6, 0(%x2)  #210 pc 768
	j	ack.202  #210 pc 772
	nop #pc 776
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 3  #0 pc 800
	addi	%x7, %x0, 10  #0 pc 804
	sw	%x1, 0(%x2)  #211 pc 808
	addi	%x2, %x2, 4  #211 pc 812
	jal	%x1, ack.202  #211 pc 816
	addi	%x2, %x2, -4  #211 pc 820
	lw	%x1, 0(%x2) #211 pc 824
	sw	%x1, 0(%x2)  #211 pc 828
	addi	%x2, %x2, 4  #211 pc 832
	jal	%x1, print_int.182  #211 pc 836
	addi	%x2, %x2, -4  #211 pc 840
	lw	%x1, 0(%x2) #211 pc 844
