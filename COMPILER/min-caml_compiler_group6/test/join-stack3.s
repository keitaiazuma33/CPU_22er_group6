...
min_caml_start:
	...
	jal	%x1, f.197  #211 pc 744
	addi	%x2, %x2, -4  #211 pc 748
	lw	%x1, 0(%x2) #211 pc 752
	sw	%x6, 0(%x2)  #212 pc 756
	bge	%x0, %x6, 12  #212 pc 760
	j	ble_else.383 #pc 764
	nop #pc 768
	sw	%x1, 4(%x2)  #212 pc 772
	addi	%x2, %x2, 8  #212 pc 776
	jal	%x1, g.199  #212 pc 780
	addi	%x2, %x2, -8  #212 pc 784
	lw	%x1, 4(%x2) #212 pc 788
	j	ble_cont.384 #pc 792
	nop #pc 796
ble_else.383: #pc 800
	sw	%x1, 4(%x2)  #212 pc 800
	addi	%x2, %x2, 8  #212 pc 804
	jal	%x1, h.201  #212 pc 808
	addi	%x2, %x2, -8  #212 pc 812
	lw	%x1, 4(%x2) #212 pc 816
ble_cont.384: #pc 820
	lw	%x7, 0(%x2)  #212 pc 820
	add	%x6, %x6, %x7  #212 pc 824
	sw	%x1, 4(%x2)  #212 pc 828
	addi	%x2, %x2, 8  #212 pc 832
	jal	%x1, print_int.177  #212 pc 836
	addi	%x2, %x2, -8  #212 pc 840
	lw	%x1, 4(%x2) #212 pc 844
