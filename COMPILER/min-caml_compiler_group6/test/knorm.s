...
bge_else.374: #pc 648
	...
	j	print_int.175  #102 pc 664
	nop #pc 668
x.195:  #pc 672
	sub	%x7, %x0, %x6  #208 pc 672
	sub	%x6, %x6, %x7  #208 pc 676
	sub	%x7, %x0, %x6  #209 pc 680
	sub	%x8, %x0, %x7  #209 pc 684
	sub	%x7, %x7, %x8  #209 pc 688
	sub	%x6, %x6, %x7  #209 pc 692
	sub	%x7, %x0, %x6  #210 pc 696
	sub	%x6, %x6, %x7  #210 pc 700
	ret #pc 704
	nop #pc 708
...
min_caml_start:
	...
	addi	%x4, %x0, 8192
	addi	%x5, %x0, 65536
	addi	%x6, %x0, 125  #0 pc 728
	sw	%x1, 0(%x2)  #211 pc 732
	addi	%x2, %x2, 4  #211 pc 736
	jal	%x1, x.195  #211 pc 740
	addi	%x2, %x2, -4  #211 pc 744
	lw	%x1, 0(%x2) #211 pc 748
	sub	%x7, %x0, %x6  #211 pc 752
	sub	%x6, %x6, %x7  #211 pc 756
	sw	%x1, 0(%x2)  #211 pc 760
	addi	%x2, %x2, 4  #211 pc 764
	jal	%x1, print_int.175  #211 pc 768
