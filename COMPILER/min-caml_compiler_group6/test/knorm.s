...
bge_else.374: #pc 656
	...
	j	print_int.175  #102 pc 672
	nop #pc 676
x.195:  #pc 680
	sub	%x7, %x0, %x6  #208 pc 680
	sub	%x6, %x6, %x7  #208 pc 684
	sub	%x7, %x0, %x6  #209 pc 688
	sub	%x8, %x0, %x7  #209 pc 692
	sub	%x7, %x7, %x8  #209 pc 696
	sub	%x6, %x6, %x7  #209 pc 700
	sub	%x7, %x0, %x6  #210 pc 704
	sub	%x6, %x6, %x7  #210 pc 708
	ret #pc 712
	nop #pc 716
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 125  #0 pc 740
	sw	%x1, 0(%x2)  #211 pc 744
	addi	%x2, %x2, 4  #211 pc 748
	jal	%x1, x.195  #211 pc 752
	addi	%x2, %x2, -4  #211 pc 756
	lw	%x1, 0(%x2) #211 pc 760
	sub	%x7, %x0, %x6  #211 pc 764
	sub	%x6, %x6, %x7  #211 pc 768
	sw	%x1, 0(%x2)  #211 pc 772
	addi	%x2, %x2, 4  #211 pc 776
	jal	%x1, print_int.175  #211 pc 780
	addi	%x2, %x2, -4  #211 pc 784
	lw	%x1, 0(%x2) #211 pc 788
