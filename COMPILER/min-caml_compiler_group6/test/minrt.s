...
fble_else.9181:
	...
	ret
	nop
float_of_int.2553:  #504
	itof	%f0, %x5  #50
	ret
	nop
int_of_float.2555:  #516
	ftoi	%x5, %f0  #53
	ret
	nop
mul_abs.2557:  #528
...
bge_else.9205:
	ret
	nop
read_float.2587:  #1812
	mv	%f0, l.6293  #0
	j	read_float_sub.2585  #156
	nop
assign_array.2589:  #1824
	beq	%x7, %x0, 12  #160
	j	be_else.9209
	nop
	slli	%x7, %x7, 2  #161
...
o_form.2684:  #3016
	...
	ret
	nop
o_reflectiontype.2686:  #3028
	lw	%x5, 8(%x5)  #485
	ret
	nop
o_isinvert.2688:  #3040
	lw	%x5, 24(%x5)  #495
	ret
	nop
o_isrot.2690:  #3052
...
o_hilight.2708:  #3188
	...
	ret
	nop
o_color_red.2710:  #3204
	lw	%x5, 32(%x5)  #603
	flw	%f0, 0(%x5)  #608
	ret
	nop
o_color_green.2712:  #3220
	lw	%x5, 32(%x5)  #613
	flw	%f0, 8(%x5)  #618
	ret
	nop
o_color_blue.2714:  #3236
	lw	%x5, 32(%x5)  #623
	flw	%f0, 16(%x5)  #628
	ret
	nop
o_param_r1.2716:  #3252
	lw	%x5, 36(%x5)  #633
	flw	%f0, 0(%x5)  #638
	ret
	nop
o_param_r2.2718:  #3268
	lw	%x5, 36(%x5)  #643
	flw	%f0, 8(%x5)  #648
	ret
	nop
o_param_r3.2720:  #3284
	lw	%x5, 36(%x5)  #653
	flw	%f0, 16(%x5)  #658
	ret
	nop
o_param_ctbl.2722:  #3300
	lw	%x5, 40(%x5)  #670
	ret
	nop
p_rgb.2724:  #3312
	...
	ret
	nop
p_intersection_points.2726:  #3324
	lw	%x5, 4(%x5)  #691
	ret
	nop
p_surface_ids.2728:  #3336
	lw	%x5, 8(%x5)  #699
	ret
	nop
p_calc_diffuse.2730:  #3348
	lw	%x5, 12(%x5)  #706
	ret
	nop
p_energy.2732:  #3360
	...
	ret
	nop
p_received_ray_20percent.2734:  #3372
	lw	%x5, 20(%x5)  #720
	ret
	nop
p_group_id.2736:  #3384
	lw	%x5, 24(%x5)  #736
	lw	%x5, 0(%x5)  #738
	ret
	nop
p_set_group_id.2738:  #3400
	lw	%x5, 24(%x5)  #743
	sw	%x6, 0(%x5)  #745
	ret
	nop
p_nvectors.2741:  #3416
	lw	%x5, 28(%x5)  #750
	ret
	nop
d_vec.2743:  #3428
...
rad.2753:  #3488
	...
	ret
	nop
read_screen_settings.2755:  #3504
	lw	%x5, 20(%x22)  #0
	lw	%x6, 16(%x22)  #0
	lw	%x7, 12(%x22)  #0
	lw	%x9, 8(%x22)  #0
...
read_light.2757:  #4140
	...
	ret
	nop
rotate_quadratic_matrix.2759:  #4488
	flw	%f0, 0(%x6)  #860
	sw	%x5, 0(%x2)  #860
	sw	%x6, 4(%x2)  #860
	sw	%x1, 12(%x2)  #860
...
be_else.9258:
	...
	jalr	%x0, %x23, 0  #985
	nop
read_all_object.2766:  #7392
	lw	%x22, 4(%x22)  #0
	addi	%x5, %x0, 0  #0
	lw	0(%x23), %x22  #992
	jalr	%x0, %x23, 0  #992
	nop
read_net_item.2768:  #7412
	sw	%x5, 0(%x2)  #999
	mv	%x5, %g0
	sw	%x1, 4(%x2)  #999
	addi	%x2, %x2, 8  #999
...
be_else.9298:
	...
	ret
	nop
solver_surface_fast.2827:  #12016
	lw	%x5, 4(%x22)  #0
	flw	%f6, 0(%x6)  #1219
	sw	%x5, 0(%x2)  #1219
	fsw	%f4, 8(%x2)  #1219
...
be_else.9326:
	...
	jalr	%x0, %x23, 0  #1260
	nop
solver_surface_fast2.2843:  #13108
	lw	%x5, 4(%x22)  #0
	flw	%f0, 0(%x6)  #1268
	sw	%x5, 0(%x2)  #1268
	sw	%x7, 4(%x2)  #1268
...
be_else.9327:
	...
	ret
	nop
solver_second_fast2.2850:  #13216
	lw	%x9, 4(%x22)  #0
	flw	%f6, 0(%x6)  #1277
	sw	%x9, 0(%x2)  #1278
	sw	%x5, 4(%x2)  #1278
...
be_cont.9342:
	ret
	nop
setup_surface_table.2863:  #14708
	addi	%x7, %x0, 4  #0
	mv	%f0, l.6293  #0
	sw	%x6, 0(%x2)  #1344
	sw	%x5, 4(%x2)  #1344
...
be_cont.9350:
	...
	ret
	nop
iter_setup_dirvec_constants.2869:  #16116
	lw	%x7, 4(%x22)  #0
	bge	%x6, %x0, 12  #1392
	j	bge_else.9351
	nop
...
bge_else.9351:
	ret
	nop
setup_dirvec_constants.2872:  #16464
	lw	%x6, 8(%x22)  #0
	lw	%x22, 4(%x22)  #0
	lw	%x6, 0(%x6)  #1409
	addi	%x6, %x6, -1  #1409
	...
	jalr	%x0, %x23, 0  #1409
	nop
setup_startp_constants.2874:  #16492
	lw	%x7, 4(%x22)  #0
	bge	%x6, %x0, 12  #1417
	j	bge_else.9357
	nop
...
be_else.9382:
	...
	ret
	nop
shadow_check_and_group.2905:  #18296
	lw	%x7, 28(%x22)  #0
	lw	%x9, 24(%x22)  #0
	lw	%x10, 20(%x22)  #0
	lw	%x11, 16(%x22)  #0
...
be_else.9389:
	...
	ret
	nop
shadow_check_one_or_group.2908:  #18812
	lw	%x7, 8(%x22)  #1536
	lw	%x9, 4(%x22)  #1536
	slli	%x10, %x5, 2  #1536
	lw	%x10, %x10(%x6)  #1536
...
be_else.9391:
	...
	ret
	nop
shadow_check_one_or_matrix.2911:  #18972
	lw	%x7, 20(%x22)  #1551
	lw	%x9, 16(%x22)  #1551
	lw	%x10, 12(%x22)  #1551
	lw	%x11, 8(%x22)  #1551
...
be_cont.9409:
	...
	jalr	%x0, %x23, 0  #1615
	nop
solve_one_or_network.2918:  #20112
	lw	%x9, 8(%x22)  #1628
	lw	%x10, 4(%x22)  #1628
	slli	%x11, %x5, 2  #1628
	lw	%x11, %x11(%x6)  #1628
...
be_else.9425:
	...
	j	fless.2540  #1670
	nop
solve_each_element_fast.2928:  #20760
	lw	%x9, 36(%x22)  #1680
	lw	%x10, 32(%x22)  #1680
	lw	%x11, 28(%x22)  #1680
	lw	%x12, 24(%x22)  #1680
...
be_cont.9432:
	...
	jalr	%x0, %x23, 0  #1709
	nop
solve_one_or_network_fast.2932:  #21472
	lw	%x9, 8(%x22)  #1721
	lw	%x10, 4(%x22)  #1721
	slli	%x11, %x5, 2  #1721
	lw	%x11, %x11(%x6)  #1721
...
be_else.9437:
	...
	jalr	%x0, %x23, 0  #1725
	nop
trace_or_matrix_fast.2936:  #21608
	lw	%x9, 16(%x22)  #1731
	lw	%x10, 12(%x22)  #1731
	lw	%x11, 8(%x22)  #1731
	lw	%x12, 4(%x22)  #1731
...
be_cont.9442:
	...
	jalr	%x0, %x23, 0  #1749
	nop
judge_intersection_fast.2940:  #21960
	lw	%x6, 12(%x22)  #0
	lw	%x7, 8(%x22)  #0
	lw	%x9, 4(%x22)  #0
	mv	%f0, l.6734  #0
...
be_else.9514:
	ret
	nop
iter_trace_diffuse_rays.2972:  #28416
	lw	%x10, 4(%x22)  #0
	bge	%x9, %x0, 12  #2066
	j	bge_else.9519
	nop
...
trace_diffuse_rays.2977:  #28736
	...
	jalr	%x0, %x23, 0  #2086
	nop
trace_diffuse_ray_80percent.2981:  #28824
	lw	%x9, 8(%x22)  #0
	lw	%x10, 4(%x22)  #0
	sw	%x7, 0(%x2)  #2093
	sw	%x6, 4(%x2)  #2093
...
be_else.9531:
	...
	jalr	%x0, %x23, 0  #2110
	nop
calc_diffuse_using_1point.2985:  #29240
	lw	%x7, 12(%x22)  #2119
	lw	%x9, 8(%x22)  #2119
	lw	%x10, 4(%x22)  #2119
	sw	%x9, 0(%x2)  #2119
	...
	nop
calc_diffuse_using_5points.2988:  #29560
	lw	%x11, 8(%x22)  #0
	lw	%x12, 4(%x22)  #0
	slli	%x13, %x5, 2  #2138
	lw	%x6, %x13(%x6)  #2138
	...
	nop
do_without_neighbors.2994:  #30100
	lw	%x7, 4(%x22)  #0
	addi	%x24, %x0, 4
	bge	%x24, %x6, 12  #2157
	j	ble_else.9533
...
get_surface_id.3001:  #30468
	...
	ret
	nop
neighbors_are_available.3004:  #30512
	slli	%x11, %x5, 2  #2191
	lw	%x11, %x11(%x7)  #2191
	sw	%x7, 0(%x2)  #2191
	sw	%x9, 4(%x2)  #2191
...
be_else.9543:
	...
	ret
	nop
try_exploit_neighbors.3010:  #30908
	lw	%x12, 8(%x22)  #2209
	lw	%x13, 4(%x22)  #2209
	slli	%x14, %x5, 2  #2209
	lw	%x14, %x14(%x9)  #2209
...
write_ppm_header.3017:  #31284
	...
	nop
write_rgb_element_int.3019:  #31520
	sw	%x1, 4(%x2)  #2250
	addi	%x2, %x2, 8  #2250
...
ble_cont.9555:
	...
	nop
write_rgb_element_char.3021:  #31612
	sw	%x1, 4(%x2)  #2256
	addi	%x2, %x2, 8  #2256
...
be_else.9562:
	...
	nop
pretrace_diffuse_rays.3025:  #31940
	lw	%x7, 12(%x22)  #0
	lw	%x9, 8(%x22)  #0
	lw	%x10, 4(%x22)  #0
	addi	%x24, %x0, 4
...
ble_cont.9581:
	...
	jalr	%x0, %x23, 0  #2383
	nop
create_float5x3array.3053:  #33948
	addi	%x5, %x0, 3  #0
	mv	%f0, l.6293  #0
	sw	%x1, 4(%x2)  #2394
	addi	%x2, %x2, 8  #2394
...
create_dirvec.3084:  #36448
	...
	ret
	nop
create_dirvec_elements.3086:  #36556
	lw	%x7, 4(%x22)  #0
	bge	%x6, %x0, 12  #2510
	j	bge_else.9595
	nop
...
bge_else.9597:
	ret
	nop
init_dirvec_constants.3091:  #36872
	lw	%x7, 4(%x22)  #0
	bge	%x6, %x0, 12  #2529
	j	bge_else.9599
	nop
...
bge_else.9599:
	ret
	nop
init_vecset_constants.3094:  #36980
	lw	%x6, 8(%x22)  #0
	lw	%x7, 4(%x22)  #0
	bge	%x5, %x0, 12  #2536
	j	bge_else.9601
...
add_reflection.3098:  #37208
	...
	ret
	nop
setup_rect_reflection.3105:  #37424
	lw	%x7, 12(%x22)  #0
	lw	%x9, 8(%x22)  #0
	lw	%x10, 4(%x22)  #0
	addi	%x11, %x0, 4  #0
	...
	ret
	nop
setup_surface_reflection.3108:  #37900
	lw	%x7, 12(%x22)  #0
	lw	%x9, 8(%x22)  #0
	lw	%x10, 4(%x22)  #0
	addi	%x11, %x0, 4  #0
...
min_caml_start:
	...
	mv	%x6, %x3  #803
	addi	%x3, %x3, 24  #803
	addi	%x24, %x0, 3504  #803 read_screen_settings.2755
	mv	%x7, %x24  #803
	sw	%x7, 0(%x6)  #803
	lw	%x7, 20(%x2)  #803
	sw	%x7, 20(%x6)  #803
	...
	mv	%x12, %x3  #836
	addi	%x3, %x3, 16  #836
	addi	%x24, %x0, 4140  #836 read_light.2757
	mv	%x13, %x24  #836
	sw	%x13, 0(%x12)  #836
	lw	%x13, 24(%x2)  #836
	sw	%x13, 8(%x12)  #836
	...
	mv	%x15, %x3  #899
	addi	%x3, %x3, 8  #899
	addi	%x24, %x0, 5552  #899 read_nth_object.2762
	mv	%x16, %x24  #899
	sw	%x16, 0(%x15)  #899
	lw	%x16, 12(%x2)  #899
	sw	%x16, 4(%x15)  #899
	mv	%x17, %x3  #982
	addi	%x3, %x3, 16  #982
	addi	%x24, %x0, 7260  #982 read_object.2764
	mv	%x18, %x24  #982
	sw	%x18, 0(%x17)  #982
	sw	%x15, 8(%x17)  #982
	lw	%x15, 8(%x2)  #982
	...
	mv	%x18, %x3  #991
	addi	%x3, %x3, 8  #991
	addi	%x24, %x0, 7392  #991 read_all_object.2766
	mv	%x19, %x24  #991
	sw	%x19, 0(%x18)  #991
	sw	%x17, 4(%x18)  #991
	mv	%x17, %x3  #1015
	addi	%x3, %x3, 8  #1015
	addi	%x24, %x0, 7668  #1015 read_and_network.2772
	mv	%x19, %x24  #1015
	sw	%x19, 0(%x17)  #1015
	lw	%x19, 36(%x2)  #1015
	sw	%x19, 4(%x17)  #1015
	mv	%x20, %x3  #1024
	addi	%x3, %x3, 24  #1024
	addi	%x24, %x0, 7776  #1024 read_parameter.2774
	mv	%x21, %x24  #1024
	sw	%x21, 0(%x20)  #1024
	sw	%x6, 20(%x20)  #1024
	sw	%x12, 16(%x20)  #1024
	...
	mv	%x12, %x3  #1049
	addi	%x3, %x3, 8  #1049
	addi	%x24, %x0, 7980  #1049 solver_rect_surface.2776
	mv	%x17, %x24  #1049
	sw	%x17, 0(%x12)  #1049
	lw	%x17, 48(%x2)  #1049
	sw	%x17, 4(%x12)  #1049
	mv	%x18, %x3  #1064
	addi	%x3, %x3, 8  #1064
	addi	%x24, %x0, 8508  #1064 solver_rect.2785
	mv	%x21, %x24  #1064
	sw	%x21, 0(%x18)  #1064
	sw	%x12, 4(%x18)  #1064
	mv	%x12, %x3  #1073
	addi	%x3, %x3, 8  #1073
	addi	%x24, %x0, 8788  #1073 solver_surface.2791
	mv	%x21, %x24  #1073
	sw	%x21, 0(%x12)  #1073
	sw	%x17, 4(%x12)  #1073
	mv	%x21, %x3  #1124
	addi	%x3, %x3, 8  #1124
	addi	%x24, %x0, 9964  #1124 solver_second.2810
	mv	%x22, %x24  #1124
	sw	%x22, 0(%x21)  #1124
	sw	%x17, 4(%x21)  #1124
	mv	%x22, %x3  #1153
	addi	%x3, %x3, 24  #1153
	addi	%x24, %x0, 10520  #1153 solver.2816
	mv	%x23, %x24  #1153
	sw	%x23, 0(%x22)  #1153
	sw	%x12, 16(%x22)  #1153
	sw	%x21, 12(%x22)  #1153
	...
	mv	%x12, %x3  #1185
	addi	%x3, %x3, 8  #1185
	addi	%x24, %x0, 10872  #1185 solver_rect_fast.2820
	mv	%x18, %x24  #1185
	sw	%x18, 0(%x12)  #1185
	sw	%x17, 4(%x12)  #1185
	mv	%x18, %x3  #1218
	addi	%x3, %x3, 8  #1218
	addi	%x24, %x0, 12016  #1218 solver_surface_fast.2827
	mv	%x21, %x24  #1218
	sw	%x21, 0(%x18)  #1218
	sw	%x17, 4(%x18)  #1218
	mv	%x21, %x3  #1227
	addi	%x3, %x3, 8  #1227
	addi	%x24, %x0, 12168  #1227 solver_second_fast.2833
	mv	%x23, %x24  #1227
	sw	%x23, 0(%x21)  #1227
	sw	%x17, 4(%x21)  #1227
	mv	%x23, %x3  #1247
	addi	%x3, %x3, 24  #1247
	sw	%x20, 148(%x2)  #1247
	addi	%x24, %x0, 12676  #1247 solver_fast.2839
	mv	%x20, %x24  #1247
	sw	%x20, 0(%x23)  #1247
	sw	%x18, 16(%x23)  #1247
	sw	%x21, 12(%x23)  #1247
	...
	mv	%x18, %x3  #1267
	addi	%x3, %x3, 8  #1267
	addi	%x24, %x0, 13108  #1267 solver_surface_fast2.2843
	mv	%x20, %x24  #1267
	sw	%x20, 0(%x18)  #1267
	sw	%x17, 4(%x18)  #1267
	mv	%x20, %x3  #1275
	addi	%x3, %x3, 8  #1275
	addi	%x24, %x0, 13216  #1275 solver_second_fast2.2850
	mv	%x21, %x24  #1275
	sw	%x21, 0(%x20)  #1275
	sw	%x17, 4(%x20)  #1275
	mv	%x21, %x3  #1294
	addi	%x3, %x3, 24  #1294
	addi	%x24, %x0, 13600  #1294 solver_fast2.2857
	mv	%x10, %x24  #1294
	sw	%x10, 0(%x21)  #1294
	sw	%x18, 16(%x21)  #1294
	sw	%x20, 12(%x21)  #1294
	...
	mv	%x10, %x3  #1391
	addi	%x3, %x3, 8  #1391
	addi	%x24, %x0, 16116  #1391 iter_setup_dirvec_constants.2869
	mv	%x12, %x24  #1391
	sw	%x12, 0(%x10)  #1391
	sw	%x16, 4(%x10)  #1391
	mv	%x12, %x3  #1408
	addi	%x3, %x3, 16  #1408
	addi	%x24, %x0, 16464  #1408 setup_dirvec_constants.2872
	mv	%x18, %x24  #1408
	sw	%x18, 0(%x12)  #1408
	sw	%x15, 8(%x12)  #1408
	sw	%x10, 4(%x12)  #1408
	mv	%x10, %x3  #1416
	addi	%x3, %x3, 8  #1416
	addi	%x24, %x0, 16492  #1416 setup_startp_constants.2874
	mv	%x18, %x24  #1416
	sw	%x18, 0(%x10)  #1416
	sw	%x16, 4(%x10)  #1416
	mv	%x18, %x3  #1435
	addi	%x3, %x3, 16  #1435
	addi	%x24, %x0, 17020  #1435 setup_startp.2877
	mv	%x20, %x24  #1435
	sw	%x20, 0(%x18)  #1435
	lw	%x20, 100(%x2)  #1435
	sw	%x20, 12(%x18)  #1435
	...
	addi	%x3, %x3, 8  #1485
	sw	%x12, 152(%x2)  #1485
	addi	%x24, %x0, 18132  #1485 check_all_inside.2899
	mv	%x12, %x24  #1485
	sw	%x12, 0(%x10)  #1485
	sw	%x16, 4(%x10)  #1485
	mv	%x12, %x3  #1505
	addi	%x3, %x3, 32  #1505
	addi	%x24, %x0, 18296  #1505 shadow_check_and_group.2905
	mv	%x15, %x24  #1505
	sw	%x15, 0(%x12)  #1505
	sw	%x23, 28(%x12)  #1505
	sw	%x17, 24(%x12)  #1505
	...
	mv	%x11, %x3  #1535
	addi	%x3, %x3, 16  #1535
	addi	%x24, %x0, 18812  #1535 shadow_check_one_or_group.2908
	mv	%x7, %x24  #1535
	sw	%x7, 0(%x11)  #1535
	sw	%x12, 8(%x11)  #1535
	sw	%x19, 4(%x11)  #1535
	mv	%x7, %x3  #1550
	addi	%x3, %x3, 24  #1550
	addi	%x24, %x0, 18972  #1550 shadow_check_one_or_matrix.2911
	mv	%x12, %x24  #1550
	sw	%x12, 0(%x7)  #1550
	sw	%x23, 20(%x7)  #1550
	sw	%x17, 16(%x7)  #1550
	...
	mv	%x11, %x3  #1586
	addi	%x3, %x3, 40  #1586
	addi	%x24, %x0, 19432  #1586 solve_each_element.2914
	mv	%x12, %x24  #1586
	sw	%x12, 0(%x11)  #1586
	lw	%x12, 56(%x2)  #1586
	sw	%x12, 36(%x11)  #1586
	...
	addi	%x3, %x3, 16  #1627
	sw	%x5, 156(%x2)  #1627
	addi	%x24, %x0, 20112  #1627 solve_one_or_network.2918
	mv	%x5, %x24  #1627
	sw	%x5, 0(%x13)  #1627
	sw	%x11, 8(%x13)  #1627
	sw	%x19, 4(%x13)  #1627
	mv	%x5, %x3  #1637
	addi	%x3, %x3, 24  #1637
	addi	%x24, %x0, 20248  #1637 trace_or_matrix.2922
	mv	%x11, %x24  #1637
	sw	%x11, 0(%x5)  #1637
	sw	%x12, 20(%x5)  #1637
	sw	%x23, 16(%x5)  #1637
	...
	mv	%x11, %x3  #1664
	addi	%x3, %x3, 16  #1664
	addi	%x24, %x0, 20608  #1664 judge_intersection.2926
	mv	%x13, %x24  #1664
	sw	%x13, 0(%x11)  #1664
	sw	%x5, 12(%x11)  #1664
	sw	%x12, 8(%x11)  #1664
	...
	mv	%x5, %x3  #1679
	addi	%x3, %x3, 40  #1679
	addi	%x24, %x0, 20760  #1679 solve_each_element_fast.2928
	mv	%x13, %x24  #1679
	sw	%x13, 0(%x5)  #1679
	sw	%x12, 36(%x5)  #1679
	sw	%x20, 32(%x5)  #1679
	...
	mv	%x10, %x3  #1720
	addi	%x3, %x3, 16  #1720
	addi	%x24, %x0, 21472  #1720 solve_one_or_network_fast.2932
	mv	%x13, %x24  #1720
	sw	%x13, 0(%x10)  #1720
	sw	%x5, 8(%x10)  #1720
	sw	%x19, 4(%x10)  #1720
	mv	%x5, %x3  #1730
	addi	%x3, %x3, 24  #1730
	addi	%x24, %x0, 21608  #1730 trace_or_matrix_fast.2936
	mv	%x13, %x24  #1730
	sw	%x13, 0(%x5)  #1730
	sw	%x12, 16(%x5)  #1730
	sw	%x21, 12(%x5)  #1730
	...
	mv	%x10, %x3  #1754
	addi	%x3, %x3, 16  #1754
	addi	%x24, %x0, 21960  #1754 judge_intersection_fast.2940
	mv	%x13, %x24  #1754
	sw	%x13, 0(%x10)  #1754
	sw	%x5, 12(%x10)  #1754
	sw	%x12, 8(%x10)  #1754
	...
	mv	%x5, %x3  #1775
	addi	%x3, %x3, 16  #1775
	addi	%x24, %x0, 22112  #1775 get_nvector_rect.2942
	mv	%x13, %x24  #1775
	sw	%x13, 0(%x5)  #1775
	lw	%x13, 68(%x2)  #1775
	sw	%x13, 8(%x5)  #1775
	...
	mv	%x17, %x3  #1783
	addi	%x3, %x3, 8  #1783
	addi	%x24, %x0, 22252  #1783 get_nvector_plane.2944
	mv	%x19, %x24  #1783
	sw	%x19, 0(%x17)  #1783
	sw	%x13, 4(%x17)  #1783
	mv	%x19, %x3  #1791
	addi	%x3, %x3, 16  #1791
	addi	%x24, %x0, 22432  #1791 get_nvector_second.2946
	mv	%x20, %x24  #1791
	sw	%x20, 0(%x19)  #1791
	sw	%x13, 8(%x19)  #1791
	sw	%x9, 4(%x19)  #1791
	mv	%x20, %x3  #1813
	addi	%x3, %x3, 16  #1813
	addi	%x24, %x0, 23168  #1813 get_nvector.2948
	mv	%x21, %x24  #1813
	sw	%x21, 0(%x20)  #1813
	sw	%x19, 12(%x20)  #1813
	sw	%x5, 8(%x20)  #1813
	...
	mv	%x5, %x3  #1829
	addi	%x3, %x3, 8  #1829
	addi	%x24, %x0, 23312  #1829 utexture.2951
	mv	%x17, %x24  #1829
	sw	%x17, 0(%x5)  #1829
	lw	%x17, 72(%x2)  #1829
	sw	%x17, 4(%x5)  #1829
	mv	%x19, %x3  #1907
	addi	%x3, %x3, 16  #1907
	addi	%x24, %x0, 25216  #1907 add_light.2954
	mv	%x21, %x24  #1907
	sw	%x21, 0(%x19)  #1907
	sw	%x17, 8(%x19)  #1907
	lw	%x21, 80(%x2)  #1907
	...
	addi	%x3, %x3, 40  #1924
	sw	%x20, 160(%x2)  #1924
	addi	%x24, %x0, 25472  #1924 trace_reflections.2958
	mv	%x20, %x24  #1924
	sw	%x20, 0(%x22)  #1924
	sw	%x7, 32(%x22)  #1924
	lw	%x20, 144(%x2)  #1924
	...
	addi	%x3, %x3, 88  #1953
	sw	%x10, 164(%x2)  #1953
	addi	%x24, %x0, 26084  #1953 trace_ray.2963
	mv	%x10, %x24  #1953
	sw	%x10, 0(%x20)  #1953
	sw	%x5, 80(%x20)  #1953
	sw	%x22, 76(%x20)  #1953
	...
	mv	%x15, %x3  #2046
	addi	%x3, %x3, 56  #2046
	addi	%x24, %x0, 27908  #2046 trace_diffuse_ray.2969
	mv	%x19, %x24  #2046
	sw	%x19, 0(%x15)  #2046
	sw	%x5, 48(%x15)  #2046
	sw	%x17, 44(%x15)  #2046
	...
	mv	%x6, %x3  #2065
	addi	%x3, %x3, 8  #2065
	addi	%x24, %x0, 28416  #2065 iter_trace_diffuse_rays.2972
	mv	%x7, %x24  #2065
	sw	%x7, 0(%x6)  #2065
	sw	%x15, 4(%x6)  #2065
	mv	%x7, %x3  #2081
	addi	%x3, %x3, 16  #2081
	addi	%x24, %x0, 28736  #2081 trace_diffuse_rays.2977
	mv	%x9, %x24  #2081
	sw	%x9, 0(%x7)  #2081
	sw	%x18, 8(%x7)  #2081
	sw	%x6, 4(%x7)  #2081
	mv	%x6, %x3  #2091
	addi	%x3, %x3, 16  #2091
	addi	%x24, %x0, 28824  #2091 trace_diffuse_ray_80percent.2981
	mv	%x9, %x24  #2091
	sw	%x9, 0(%x6)  #2091
	sw	%x7, 8(%x6)  #2091
	lw	%x9, 124(%x2)  #2091
	...
	mv	%x11, %x3  #2117
	addi	%x3, %x3, 16  #2117
	addi	%x24, %x0, 29240  #2117 calc_diffuse_using_1point.2985
	mv	%x13, %x24  #2117
	sw	%x13, 0(%x11)  #2117
	sw	%x6, 12(%x11)  #2117
	sw	%x21, 8(%x11)  #2117
	...
	mv	%x6, %x3  #2136
	addi	%x3, %x3, 16  #2136
	addi	%x24, %x0, 29560  #2136 calc_diffuse_using_5points.2988
	mv	%x13, %x24  #2136
	sw	%x13, 0(%x6)  #2136
	sw	%x21, 8(%x6)  #2136
	sw	%x5, 4(%x6)  #2136
	mv	%x13, %x3  #2156
	addi	%x3, %x3, 8  #2156
	addi	%x24, %x0, 30100  #2156 do_without_neighbors.2994
	mv	%x14, %x24  #2156
	sw	%x14, 0(%x13)  #2156
	sw	%x11, 4(%x13)  #2156
	mv	%x11, %x3  #2171
	addi	%x3, %x3, 8  #2171
	addi	%x24, %x0, 30324  #2171 neighbors_exist.2997
	mv	%x14, %x24  #2171
	sw	%x14, 0(%x11)  #2171
	lw	%x14, 84(%x2)  #2171
	sw	%x14, 4(%x11)  #2171
	mv	%x15, %x3  #2208
	addi	%x3, %x3, 16  #2208
	addi	%x24, %x0, 30908  #2208 try_exploit_neighbors.3010
	mv	%x17, %x24  #2208
	sw	%x17, 0(%x15)  #2208
	sw	%x13, 8(%x15)  #2208
	sw	%x6, 4(%x15)  #2208
	mv	%x6, %x3  #2235
	addi	%x3, %x3, 8  #2235
	addi	%x24, %x0, 31284  #2235 write_ppm_header.3017
	mv	%x17, %x24  #2235
	sw	%x17, 0(%x6)  #2235
	sw	%x14, 4(%x6)  #2235
	mv	%x17, %x3  #2261
	addi	%x3, %x3, 8  #2261
	addi	%x24, %x0, 31704  #2261 write_rgb.3023
	mv	%x18, %x24  #2261
	sw	%x18, 0(%x17)  #2261
	sw	%x21, 4(%x17)  #2261
	mv	%x18, %x3  #2284
	addi	%x3, %x3, 16  #2284
	addi	%x24, %x0, 31940  #2284 pretrace_diffuse_rays.3025
	mv	%x19, %x24  #2284
	sw	%x19, 0(%x18)  #2284
	sw	%x7, 12(%x18)  #2284
	sw	%x9, 8(%x18)  #2284
	...
	mv	%x5, %x3  #2314
	addi	%x3, %x3, 40  #2314
	addi	%x24, %x0, 32392  #2314 pretrace_pixels.3028
	mv	%x7, %x24  #2314
	sw	%x7, 0(%x5)  #2314
	lw	%x7, 20(%x2)  #2314
	sw	%x7, 36(%x5)  #2314
	...
	mv	%x19, %x3  #2339
	addi	%x3, %x3, 32  #2339
	addi	%x24, %x0, 33028  #2339 pretrace_line.3035
	mv	%x20, %x24  #2339
	sw	%x20, 0(%x19)  #2339
	lw	%x20, 112(%x2)  #2339
	sw	%x20, 24(%x19)  #2339
	...
	mv	%x5, %x3  #2355
	addi	%x3, %x3, 32  #2355
	addi	%x24, %x0, 33248  #2355 scan_pixel.3039
	mv	%x20, %x24  #2355
	sw	%x20, 0(%x5)  #2355
	sw	%x17, 24(%x5)  #2355
	sw	%x15, 20(%x5)  #2355
	...
	mv	%x11, %x3  #2375
	addi	%x3, %x3, 16  #2375
	addi	%x24, %x0, 33660  #2375 scan_line.3046
	mv	%x13, %x24  #2375
	sw	%x13, 0(%x11)  #2375
	sw	%x5, 12(%x11)  #2375
	sw	%x19, 8(%x11)  #2375
	...
	mv	%x5, %x3  #2427
	addi	%x3, %x3, 8  #2427
	addi	%x24, %x0, 34596  #2427 create_pixelline.3060
	mv	%x13, %x24  #2427
	sw	%x13, 0(%x5)  #2427
	sw	%x14, 4(%x5)  #2427
	mv	%x13, %x3  #2455
	addi	%x3, %x3, 8  #2455
	addi	%x24, %x0, 34864  #2455 calc_dirvec.3067
	mv	%x15, %x24  #2455
	sw	%x15, 0(%x13)  #2455
	sw	%x9, 4(%x13)  #2455
	mv	%x15, %x3  #2476
	addi	%x3, %x3, 8  #2476
	addi	%x24, %x0, 35932  #2476 calc_dirvecs.3075
	mv	%x17, %x24  #2476
	sw	%x17, 0(%x15)  #2476
	sw	%x13, 4(%x15)  #2476
	mv	%x13, %x3  #2490
	addi	%x3, %x3, 8  #2490
	addi	%x24, %x0, 36248  #2490 calc_dirvec_rows.3080
	mv	%x17, %x24  #2490
	sw	%x17, 0(%x13)  #2490
	sw	%x15, 4(%x13)  #2490
	mv	%x15, %x3  #2503
	addi	%x3, %x3, 8  #2503
	addi	%x24, %x0, 36448  #2503 create_dirvec.3084
	mv	%x17, %x24  #2503
	sw	%x17, 0(%x15)  #2503
	lw	%x17, 8(%x2)  #2503
	sw	%x17, 4(%x15)  #2503
	mv	%x20, %x3  #2509
	addi	%x3, %x3, 8  #2509
	addi	%x24, %x0, 36556  #2509 create_dirvec_elements.3086
	mv	%x21, %x24  #2509
	sw	%x21, 0(%x20)  #2509
	sw	%x15, 4(%x20)  #2509
	mv	%x21, %x3  #2516
	addi	%x3, %x3, 16  #2516
	addi	%x24, %x0, 36668  #2516 create_dirvecs.3089
	mv	%x22, %x24  #2516
	sw	%x22, 0(%x21)  #2516
	sw	%x9, 12(%x21)  #2516
	sw	%x20, 8(%x21)  #2516
	...
	mv	%x20, %x3  #2528
	addi	%x3, %x3, 8  #2528
	addi	%x24, %x0, 36872  #2528 init_dirvec_constants.3091
	mv	%x22, %x24  #2528
	sw	%x22, 0(%x20)  #2528
	lw	%x22, 152(%x2)  #2528
	sw	%x22, 4(%x20)  #2528
	...
	addi	%x3, %x3, 16  #2535
	sw	%x5, 168(%x2)  #2535
	addi	%x24, %x0, 36980  #2535 init_vecset_constants.3094
	mv	%x5, %x24  #2535
	sw	%x5, 0(%x23)  #2535
	sw	%x20, 8(%x23)  #2535
	sw	%x9, 4(%x23)  #2535
	mv	%x5, %x3  #2542
	addi	%x3, %x3, 16  #2542
	addi	%x24, %x0, 37092  #2542 init_dirvecs.3096
	mv	%x9, %x24  #2542
	sw	%x9, 0(%x5)  #2542
	sw	%x23, 12(%x5)  #2542
	sw	%x21, 8(%x5)  #2542
	...
	mv	%x9, %x3  #2553
	addi	%x3, %x3, 16  #2553
	addi	%x24, %x0, 37208  #2553 add_reflection.3098
	mv	%x13, %x24  #2553
	sw	%x13, 0(%x9)  #2553
	sw	%x22, 12(%x9)  #2553
	lw	%x13, 144(%x2)  #2553
	...
	mv	%x13, %x3  #2562
	addi	%x3, %x3, 16  #2562
	addi	%x24, %x0, 37424  #2562 setup_rect_reflection.3105
	mv	%x15, %x24  #2562
	sw	%x15, 0(%x13)  #2562
	sw	%x10, 12(%x13)  #2562
	sw	%x12, 8(%x13)  #2562
	...
	mv	%x15, %x3  #2576
	addi	%x3, %x3, 16  #2576
	addi	%x24, %x0, 37900  #2576 setup_surface_reflection.3108
	mv	%x20, %x24  #2576
	sw	%x20, 0(%x15)  #2576
	sw	%x10, 12(%x15)  #2576
	sw	%x12, 8(%x15)  #2576
	...
	mv	%x9, %x3  #2591
	addi	%x3, %x3, 16  #2591
	addi	%x24, %x0, 38348  #2591 setup_reflections.3111
	mv	%x10, %x24  #2591
	sw	%x10, 0(%x9)  #2591
	sw	%x15, 12(%x9)  #2591
	sw	%x13, 8(%x9)  #2591
	...
	mv	%x10, %x3  #2613
	addi	%x3, %x3, 64  #2613
	addi	%x24, %x0, 38640  #2613 rt.3113
	mv	%x13, %x24  #2613
	sw	%x13, 0(%x10)  #2613
	sw	%x6, 56(%x10)  #2613
	sw	%x9, 52(%x10)  #2613
