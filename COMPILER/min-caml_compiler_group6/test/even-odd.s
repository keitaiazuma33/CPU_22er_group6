...
bge_else.388: #pc 648
	...
	j	print_int.182  #102 pc 664
	nop #pc 668
odd.208:  #pc 672
	bge	%x0, %x6, 12  #211 pc 672
	j	ble_else.392 #pc 676
	nop #pc 680
	bge	%x6, %x0, 12  #212 pc 684
	j	bge_else.393 #pc 688
	nop #pc 692
	addi	%x6, %x0, 456  #0 pc 696
	ret #pc 700
	nop #pc 704
bge_else.393: #pc 708
	addi	%x6, %x6, 1  #212 pc 708
	j	even.204  #212 pc 712
	nop #pc 716
ble_else.392: #pc 720
	addi	%x6, %x6, -1  #211 pc 720
	j	even.204  #211 pc 724
	nop #pc 728
even.204:  #pc 732
	bge	%x0, %x6, 12  #214 pc 732
	j	ble_else.394 #pc 736
	nop #pc 740
	bge	%x6, %x0, 12  #215 pc 744
	j	bge_else.395 #pc 748
	nop #pc 752
	addi	%x6, %x0, 123  #0 pc 756
	ret #pc 760
	nop #pc 764
bge_else.395: #pc 768
	addi	%x6, %x6, 1  #215 pc 768
	j	odd.208  #215 pc 772
	nop #pc 776
ble_else.394: #pc 780
	addi	%x6, %x6, -1  #214 pc 780
	j	odd.208  #214 pc 784
	nop #pc 788
...
min_caml_start:
	...
	addi	%x4, %x0, 8192
	addi	%x5, %x0, 65536
	addi	%x6, %x0, 789  #0 pc 808
	sw	%x1, 0(%x2)  #217 pc 812
	addi	%x2, %x2, 4  #217 pc 816
	jal	%x1, even.204  #217 pc 820
	addi	%x2, %x2, -4  #217 pc 824
	lw	%x1, 0(%x2) #217 pc 828
	sw	%x1, 0(%x2)  #217 pc 832
	addi	%x2, %x2, 4  #217 pc 836
	jal	%x1, print_int.182  #217 pc 840
	addi	%x2, %x2, -4  #217 pc 844
	lw	%x1, 0(%x2) #217 pc 848
