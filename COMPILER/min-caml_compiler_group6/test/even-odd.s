...
be_else.407: #pc 72
	...
	j	mul_abs.164  #63 pc 88
	nop #pc 92
div_abs.172:  #pc 96
	addi	%x31, %x0, -1  #pc 96
	beq	%x8, %x31, 12  #77 pc 100
	j	be_else.408 #pc 104
	nop #pc 108
...
be_else.408: #pc 124
	...
	j	div_abs.172  #81 pc 168
	nop #pc 172
ble_else.409: #pc 176
	addi	%x8, %x8, -1  #83 pc 176
	j	div_abs.172  #83 pc 180
	nop #pc 184
print_int.182:  #pc 188
	bge	%x6, %x0, 12  #100 pc 188
	j	bge_else.410 #pc 192
	nop #pc 196
	addi	%x31, %x0, 10  #pc 200
	bge	%x6, %x31, 12  #104 pc 204
	j	bge_else.411 #pc 208
	nop #pc 212
	bge	%x6, %x0, 12  #107 pc 216
	j	bge_else.412 #pc 220
	nop #pc 224
	addi	%x7, %x6, 0  #107 pc 228
	j	bge_cont.413 #pc 232
	nop #pc 236
bge_else.412: #pc 240
...
bge_else.410: #pc 512
	...
	j	print_int.182  #102 pc 528
	nop #pc 532
even.204:  #pc 536
	bge	%x0, %x6, 12  #214 pc 536
	j	ble_else.422 #pc 540
	nop #pc 544
	bge	%x6, %x0, 12  #215 pc 548
	j	bge_else.423 #pc 552
	nop #pc 556
	addi	%x6, %x0, 123  #0 pc 560
	ret #pc 564
	nop #pc 568
bge_else.423: #pc 572
	addi	%x6, %x6, 1  #215 pc 572
	bge	%x0, %x6, 12  #215 pc 576
	j	ble_else.424 #pc 580
	nop #pc 584
	bge	%x6, %x0, 12  #215 pc 588
	j	bge_else.425 #pc 592
	nop #pc 596
	addi	%x6, %x0, 456  #0 pc 600
	ret #pc 604
	nop #pc 608
bge_else.425: #pc 612
	addi	%x6, %x6, 1  #215 pc 612
	j	even.204  #215 pc 616
	nop #pc 620
ble_else.424: #pc 624
	addi	%x6, %x6, -1  #215 pc 624
	j	even.204  #215 pc 628
	nop #pc 632
ble_else.422: #pc 636
	addi	%x6, %x6, -1  #214 pc 636
	bge	%x0, %x6, 12  #214 pc 640
	j	ble_else.426 #pc 644
	nop #pc 648
	bge	%x6, %x0, 12  #214 pc 652
	j	bge_else.427 #pc 656
	nop #pc 660
	addi	%x6, %x0, 456  #0 pc 664
	ret #pc 668
	nop #pc 672
bge_else.427: #pc 676
	addi	%x6, %x6, 1  #214 pc 676
	j	even.204  #214 pc 680
	nop #pc 684
ble_else.426: #pc 688
	addi	%x6, %x6, -1  #214 pc 688
	j	even.204  #214 pc 692
	nop #pc 696
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 789  #0 pc 720
	sw	%x1, 0(%x2)  #217 pc 724
	addi	%x2, %x2, 4  #217 pc 728
	jal	%x1, even.204  #217 pc 732
	addi	%x2, %x2, -4  #217 pc 736
	lw	%x1, 0(%x2) #217 pc 740
	sw	%x1, 0(%x2)  #217 pc 744
	addi	%x2, %x2, 4  #217 pc 748
	jal	%x1, print_int.182  #217 pc 752
	addi	%x2, %x2, -4  #217 pc 756
	lw	%x1, 0(%x2) #217 pc 760
