...
min_caml_start:
	...
	jal	%x1, g.201  #212 pc 768
	addi	%x2, %x2, -8  #212 pc 772
	lw	%x1, 4(%x2) #212 pc 776
	sw	%x6, 4(%x2)  #213 pc 780
	sw	%x1, 8(%x2)  #213 pc 784
	addi	%x2, %x2, 12  #213 pc 788
	jal	%x1, h.203  #213 pc 792
	addi	%x2, %x2, -12  #213 pc 796
	lw	%x1, 8(%x2) #213 pc 800
	beq	%x6, %x0, 12  #213 pc 804
	j	be_else.387 #pc 808
	nop #pc 812
	lw	%x6, 4(%x2)  #213 pc 816
	lw	%x7, 0(%x2)  #213 pc 820
	sub	%x6, %x7, %x6  #213 pc 824
	j	be_cont.388 #pc 828
	nop #pc 832
be_else.387: #pc 836
	lw	%x6, 0(%x2)  #213 pc 836
	lw	%x7, 4(%x2)  #213 pc 840
	sub	%x6, %x7, %x6  #213 pc 844
be_cont.388: #pc 848
	lw	%x7, 0(%x2)  #213 pc 848
	add	%x6, %x6, %x7  #213 pc 852
	lw	%x7, 4(%x2)  #213 pc 856
	add	%x6, %x6, %x7  #213 pc 860
	sw	%x1, 8(%x2)  #213 pc 864
	addi	%x2, %x2, 12  #213 pc 868
	jal	%x1, print_int.179  #213 pc 872
	addi	%x2, %x2, -12  #213 pc 876
	lw	%x1, 8(%x2) #213 pc 880
