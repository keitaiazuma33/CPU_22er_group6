...
bge_cont.383: #pc 244
	...
	j	be_else.384 #pc 308
	nop #pc 312
	j	be_cont.385 #pc 316
	nop #pc 320
be_else.384: #pc 324
...
be_cont.385: #pc 328
	...
	j	bge_else.386 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.387 #pc 372
	nop #pc 376
bge_else.386: #pc 380
...
bge_cont.387: #pc 384
	...
	j	be_else.388 #pc 444
	nop #pc 448
	j	be_cont.389 #pc 452
	nop #pc 456
be_else.388: #pc 460
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 123  #0 pc 556
	sw	%x1, 0(%x2)  #207 pc 560
	addi	%x2, %x2, 4  #207 pc 564
	jal	%x1, print_int.176  #207 pc 568
	addi	%x2, %x2, -4  #207 pc 572
	lw	%x1, 0(%x2) #207 pc 576
	addi	%x6, %x0, -456  #0 pc 580
	sw	%x1, 0(%x2)  #208 pc 584
	addi	%x2, %x2, 4  #208 pc 588
	jal	%x1, print_int.176  #208 pc 592
	addi	%x2, %x2, -4  #208 pc 596
	lw	%x1, 0(%x2) #208 pc 600
	addi	%x6, %x0, 789  #0 pc 604
	sw	%x1, 0(%x2)  #209 pc 608
	addi	%x2, %x2, 4  #209 pc 612
	jal	%x1, print_int.176  #209 pc 616
	addi	%x2, %x2, -4  #209 pc 620
	lw	%x1, 0(%x2) #209 pc 624
