...
min_caml_start:
	...
	addi	%x4, %x0, 8192
	addi	%x5, %x0, 65536
	addi	%x6, %x0, 123  #0 pc 688
	sw	%x1, 0(%x2)  #207 pc 692
	addi	%x2, %x2, 4  #207 pc 696
	jal	%x1, print_int.176  #207 pc 700
	addi	%x2, %x2, -4  #207 pc 704
	lw	%x1, 0(%x2) #207 pc 708
	addi	%x6, %x0, -456  #0 pc 712
	sw	%x1, 0(%x2)  #208 pc 716
	addi	%x2, %x2, 4  #208 pc 720
	jal	%x1, print_int.176  #208 pc 724
	addi	%x2, %x2, -4  #208 pc 728
	lw	%x1, 0(%x2) #208 pc 732
	addi	%x6, %x0, 789  #0 pc 736
	sw	%x1, 0(%x2)  #209 pc 740
	addi	%x2, %x2, 4  #209 pc 744
	jal	%x1, print_int.176  #209 pc 748
	addi	%x2, %x2, -4  #209 pc 752
	lw	%x1, 0(%x2) #209 pc 756
