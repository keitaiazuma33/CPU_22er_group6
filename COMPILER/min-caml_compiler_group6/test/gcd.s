...
bge_else.379: #pc 512
	...
	nop #pc 532
gcd.194:  #pc 536
	beq	%x6, %x0, 12  #208 pc 536
	j	be_else.391 #pc 540
	nop #pc 544
	addi	%x6, %x7, 0  #208 pc 548
	ret #pc 552
	nop #pc 556
be_else.391: #pc 560
	bge	%x7, %x6, 12  #209 pc 560
	j	ble_else.392 #pc 564
	nop #pc 568
	sub	%x7, %x7, %x6  #209 pc 572
	j	gcd.194  #209 pc 576
	nop #pc 580
ble_else.392: #pc 584
	sub	%x6, %x6, %x7  #210 pc 584
	addi	%x30, %x7, 0  #0 pc 588
	addi	%x7, %x6, 0  #0 pc 592
	addi	%x6, %x30, 0  #0 pc 596
	j	gcd.194  #210 pc 600
	nop #pc 604
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 21600  #0 pc 628
	addi	%x7, %x0, 337500  #0 pc 632
	sw	%x1, 0(%x2)  #211 pc 636
	addi	%x2, %x2, 4  #211 pc 640
	jal	%x1, gcd.194  #211 pc 644
	addi	%x2, %x2, -4  #211 pc 648
	lw	%x1, 0(%x2) #211 pc 652
	sw	%x1, 0(%x2)  #211 pc 656
	addi	%x2, %x2, 4  #211 pc 660
	jal	%x1, print_int.174  #211 pc 664
	addi	%x2, %x2, -4  #211 pc 668
	lw	%x1, 0(%x2) #211 pc 672
