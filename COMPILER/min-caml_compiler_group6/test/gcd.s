...
bge_else.369: #pc 648
	...
	nop #pc 668
gcd.194:  #pc 672
	beq	%x6, %x0, 12  #208 pc 672
	j	be_else.373 #pc 676
	nop #pc 680
	addi	%x6, %x7, 0  #208 pc 684
	ret #pc 688
	nop #pc 692
be_else.373: #pc 696
	bge	%x7, %x6, 12  #209 pc 696
	j	ble_else.374 #pc 700
	nop #pc 704
	sub	%x7, %x7, %x6  #209 pc 708
	j	gcd.194  #209 pc 712
	nop #pc 716
ble_else.374: #pc 720
	sub	%x6, %x6, %x7  #210 pc 720
	addi	%x30, %x7, 0  #0 pc 724
	addi	%x7, %x6, 0  #0 pc 728
	addi	%x6, %x30, 0  #0 pc 732
	j	gcd.194  #210 pc 736
	nop #pc 740
