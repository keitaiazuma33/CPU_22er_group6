...
h.213:  #pc 788
	...
	addi	%x31, %x0, 672  #210 g.239 pc 836
	addi	%x16, %x31, 0  #210 pc 840
	sw	%x16, 0(%x29)  #210 pc 844
	sw	%x8, 40(%x29)  #210 pc 848
	sw	%x9, 36(%x29)  #210 pc 852
	sw	%x10, 32(%x29)  #210 pc 856
	sw	%x11, 28(%x29)  #210 pc 860
	sw	%x12, 24(%x29)  #210 pc 864
	sw	%x13, 20(%x29)  #210 pc 868
	sw	%x14, 16(%x29)  #210 pc 872
	sw	%x15, 12(%x29)  #210 pc 876
	sw	%x7, 8(%x29)  #210 pc 880
	sw	%x6, 4(%x29)  #210 pc 884
