...
min_caml_start:
	...
	jal	%x1, f.201  #211 pc 744
	addi	%x2, %x2, -4  #211 pc 748
	lw	%x1, 0(%x2) #211 pc 752
	sw	%x6, 0(%x2)  #212 pc 756
	sw	%x1, 4(%x2)  #212 pc 760
	addi	%x2, %x2, 8  #212 pc 764
	jal	%x1, g.203  #212 pc 768
	addi	%x2, %x2, -8  #212 pc 772
	lw	%x1, 4(%x2) #212 pc 776
	sw	%x6, 4(%x2)  #213 pc 780
	sw	%x1, 8(%x2)  #213 pc 784
	addi	%x2, %x2, 12  #213 pc 788
	jal	%x1, h.205  #213 pc 792
	addi	%x2, %x2, -12  #213 pc 796
	lw	%x1, 8(%x2) #213 pc 800
	beq	%x6, %x0, 12  #213 pc 804
	j	be_else.391 #pc 808
	nop #pc 812
	lw	%x6, 0(%x2)  #213 pc 816
	addi	%x6, %x6, 1  #213 pc 820
	j	be_cont.392 #pc 824
	nop #pc 828
be_else.391: #pc 832
	lw	%x6, 4(%x2)  #213 pc 832
	addi	%x6, %x6, 2  #213 pc 836
be_cont.392: #pc 840
	lw	%x7, 0(%x2)  #213 pc 840
	add	%x6, %x6, %x7  #213 pc 844
	lw	%x7, 4(%x2)  #213 pc 848
	add	%x6, %x6, %x7  #213 pc 852
	sw	%x1, 8(%x2)  #213 pc 856
	addi	%x2, %x2, 12  #213 pc 860
	jal	%x1, print_int.181  #213 pc 864
	addi	%x2, %x2, -12  #213 pc 868
	lw	%x1, 8(%x2) #213 pc 872
