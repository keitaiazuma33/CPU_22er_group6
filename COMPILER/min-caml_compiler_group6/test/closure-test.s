...
min_caml_start:
	...
	addi	%x5, %x3, 0  #16 pc 364
	addi	%x3, %x3, 8  #16 pc 368
	addi	%x24, %x0, 120  #16 i.32 pc 372
	addi	%x6, %x24, 0  #16 pc 376
	add	%x24, %x0, %x5  #16 pc 380
	sw	%x6, 0(%x24)  #16 pc 384
	addi	%x6, %x0, 7  #0 pc 388
	sw	%x5, 8(%x2)  #20 pc 392
	addi	%x5, %x6, 0  #0 pc 400
	sw	%x1, 12(%x2)  #20 pc 404
	addi	%x2, %x2, 16  #20 pc 408
	jal	%x1, f.35  #20 pc 412
	addi	%x2, %x2, -16  #20 pc 416
	lw	%x1, 12(%x2) #20 pc 420
	addi	%x6, %x3, 0  #20 pc 424
	addi	%x3, %x3, 8  #20 pc 428
	addi	%x24, %x0, 4  #pc 432
	add	%x24, %x24, %x6  #20 pc 436
	sw	%x5, 0(%x24)  #20 pc 440
	lw	%x5, 8(%x2)  #20 pc 444
	add	%x24, %x0, %x6  #20 pc 448
	sw	%x5, 0(%x24)  #20 pc 452
	addi	%x5, %x6, 0  #20 pc 456
	sw	%x1, 12(%x2)  #20 pc 460
	addi	%x2, %x2, 16  #20 pc 464
	jal	%x1, min_caml_print_var5  #20 pc 468
	addi	%x2, %x2, -16  #20 pc 472
	lw	%x1, 12(%x2) #20 pc 476
	addi	%x2, %x2, 112
