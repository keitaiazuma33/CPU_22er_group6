...
bge_else.376: #pc 648
	...
	j	print_int.177  #102 pc 664
	nop #pc 668
fib.197:  #pc 672
	addi	%x31, %x0, 1  #pc 672
	bge	%x31, %x6, 12  #208 pc 676
	j	ble_else.380 #pc 680
	nop #pc 684
	ret #pc 688
	nop #pc 692
ble_else.380: #pc 696
	...
	jal	%x1, fib.197  #209 pc 716
	addi	%x2, %x2, -8  #209 pc 720
	lw	%x1, 4(%x2) #209 pc 724
	lw	%x7, 0(%x2)  #209 pc 728
	addi	%x7, %x7, -2  #209 pc 732
	sw	%x6, 4(%x2)  #209 pc 736
	addi	%x6, %x7, 0  #0 pc 740
	sw	%x1, 8(%x2)  #209 pc 744
	addi	%x2, %x2, 12  #209 pc 748
	jal	%x1, fib.197  #209 pc 752
	addi	%x2, %x2, -12  #209 pc 756
	lw	%x1, 8(%x2) #209 pc 760
	lw	%x7, 4(%x2)  #209 pc 764
	add	%x6, %x7, %x6  #209 pc 768
	ret #pc 772
	nop #pc 776
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 30  #0 pc 800
	sw	%x1, 0(%x2)  #210 pc 804
	addi	%x2, %x2, 4  #210 pc 808
	jal	%x1, fib.197  #210 pc 812
	addi	%x2, %x2, -4  #210 pc 816
	lw	%x1, 0(%x2) #210 pc 820
	sw	%x1, 0(%x2)  #210 pc 824
	addi	%x2, %x2, 4  #210 pc 828
	jal	%x1, print_int.177  #210 pc 832
	addi	%x2, %x2, -4  #210 pc 836
	lw	%x1, 0(%x2) #210 pc 840
