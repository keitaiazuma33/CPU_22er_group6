...
min_caml_start:
	...
	addi	%x4, %x0, 8192
	addi	%x5, %x0, 65536
	addi	%x6, %x0, 30  #0 pc 796
	sw	%x1, 0(%x2)  #210 pc 800
	addi	%x2, %x2, 4  #210 pc 804
	jal	%x1, fib.197  #210 pc 808
	addi	%x2, %x2, -4  #210 pc 812
	lw	%x1, 0(%x2) #210 pc 816
	sw	%x1, 0(%x2)  #210 pc 820
	addi	%x2, %x2, 4  #210 pc 824
	jal	%x1, print_int.177  #210 pc 828
	addi	%x2, %x2, -4  #210 pc 832
	lw	%x1, 0(%x2) #210 pc 836
