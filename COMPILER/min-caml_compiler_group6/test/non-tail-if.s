...
bge_cont.402: #pc 244
	...
	j	be_else.403 #pc 308
	nop #pc 312
	j	be_cont.404 #pc 316
	nop #pc 320
be_else.403: #pc 324
...
be_cont.404: #pc 328
	...
	j	bge_else.405 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.406 #pc 372
	nop #pc 376
bge_else.405: #pc 380
...
bge_cont.406: #pc 384
	...
	j	be_else.407 #pc 444
	nop #pc 448
	j	be_cont.408 #pc 452
	nop #pc 456
be_else.407: #pc 460
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	fmv	%f0, l.383  #0 pc 556
	ftoi	%x6, %f0  #211 pc 560
	fmv	%f0, l.385  #0 pc 564
	ftoi	%x7, %f0  #212 pc 568
	fmv	%f0, l.387  #0 pc 572
	ftoi	%x8, %f0  #213 pc 576
	bge	%x8, %x0, 12  #215 pc 580
	j	bge_else.411 #pc 584
	nop #pc 588
	addi	%x9, %x6, 0  #215 pc 592
	j	bge_cont.412 #pc 596
	nop #pc 600
bge_else.411: #pc 604
	addi	%x9, %x7, 0  #215 pc 604
bge_cont.412: #pc 608
	bge	%x0, %x6, 12  #216 pc 608
	j	ble_else.413 #pc 612
	nop #pc 616
	addi	%x10, %x7, 0  #216 pc 620
	j	ble_cont.414 #pc 624
	nop #pc 628
ble_else.413: #pc 632
	addi	%x10, %x8, 0  #216 pc 632
ble_cont.414: #pc 636
	add	%x9, %x9, %x10  #215 pc 636
	bge	%x7, %x0, 12  #217 pc 640
	j	bge_else.415 #pc 644
	nop #pc 648
	addi	%x6, %x8, 0  #217 pc 652
	j	bge_cont.416 #pc 656
	nop #pc 660
bge_else.415: #pc 664
bge_cont.416: #pc 664
	add	%x6, %x9, %x6  #215 pc 664
	sw	%x1, 0(%x2)  #214 pc 668
	addi	%x2, %x2, 4  #214 pc 672
	jal	%x1, print_int.180  #214 pc 676
	addi	%x2, %x2, -4  #214 pc 680
	lw	%x1, 0(%x2) #214 pc 684
