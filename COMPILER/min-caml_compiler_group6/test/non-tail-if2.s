...
bge_else.389: #pc 656
	...
	nop #pc 676
assign_array.186:  #pc 680
	bge	%x8, %x0, 12  #169 pc 680
	j	bge_else.393 #pc 684
	nop #pc 688
	beq	%x8, %x0, 12  #172 pc 692
	j	be_else.394 #pc 696
	nop #pc 700
...
be_else.394: #pc 724
	...
	j	assign_array.186  #176 pc 740
	nop #pc 744
bge_else.393: #pc 748
	ret #pc 748
	nop #pc 752
create_array.190:  #pc 756
	...
	jal	%x1, assign_array.186  #183 pc 796
...
min_caml_start:
	...
	addi	%x7, %x0, 3  #0 pc 856
	sw	%x1, 0(%x2)  #208 pc 860
	addi	%x2, %x2, 4  #208 pc 864
	jal	%x1, create_array.190  #208 pc 868
	addi	%x2, %x2, -4  #208 pc 872
	lw	%x1, 0(%x2) #208 pc 876
	addi	%x7, %x0, 67890  #0 pc 880
	lw	%x8, 0(%x6)  #210 pc 884
	addi	%x31, %x0, 3  #pc 888
	beq	%x8, %x31, 12  #210 pc 892
	j	be_else.397 #pc 896
	nop #pc 900
	sw	%x7, 0(%x2)  #210 pc 904
	sw	%x6, 4(%x2)  #210 pc 908
	sw	%x1, 8(%x2)  #210 pc 912
	addi	%x2, %x2, 12  #210 pc 916
	jal	%x1, f.200  #210 pc 920
	addi	%x2, %x2, -12  #210 pc 924
	lw	%x1, 8(%x2) #210 pc 928
	lw	%x7, 4(%x2)  #210 pc 932
	lw	%x7, 4(%x7)  #210 pc 936
	add	%x6, %x6, %x7  #210 pc 940
	lw	%x7, 0(%x2)  #210 pc 944
	add	%x6, %x6, %x7  #210 pc 948
	j	be_cont.398 #pc 952
	nop #pc 956
be_else.397: #pc 960
	addi	%x6, %x0, 7  #0 pc 960
be_cont.398: #pc 964
	sw	%x1, 8(%x2)  #210 pc 964
	addi	%x2, %x2, 12  #210 pc 968
	jal	%x1, print_int.180  #210 pc 972
	addi	%x2, %x2, -12  #210 pc 976
	lw	%x1, 8(%x2) #210 pc 980
