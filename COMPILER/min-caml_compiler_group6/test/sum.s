...
bge_cont.382: #pc 244
	...
	j	be_else.383 #pc 308
	nop #pc 312
	j	be_cont.384 #pc 316
	nop #pc 320
be_else.383: #pc 324
...
be_cont.384: #pc 328
	...
	j	bge_else.385 #pc 360
	nop #pc 364
	addi	%x7, %x6, 0  #109 pc 368
	j	bge_cont.386 #pc 372
	nop #pc 376
bge_else.385: #pc 380
...
bge_cont.386: #pc 384
	...
	j	be_else.387 #pc 444
	nop #pc 448
	j	be_cont.388 #pc 452
	nop #pc 456
be_else.387: #pc 460
...
sum.194:  #pc 536
	...
	j	ble_else.391 #pc 540
	nop #pc 544
	addi	%x6, %x0, 0  #0 pc 548
	ret #pc 552
	nop #pc 556
ble_else.391: #pc 560
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 10000  #0 pc 628
	sw	%x1, 0(%x2)  #210 pc 632
	addi	%x2, %x2, 4  #210 pc 636
	jal	%x1, sum.194  #210 pc 640
	addi	%x2, %x2, -4  #210 pc 644
	lw	%x1, 0(%x2) #210 pc 648
	sw	%x1, 0(%x2)  #210 pc 652
	addi	%x2, %x2, 4  #210 pc 656
	jal	%x1, print_int.174  #210 pc 660
	addi	%x2, %x2, -4  #210 pc 664
	lw	%x1, 0(%x2) #210 pc 668
