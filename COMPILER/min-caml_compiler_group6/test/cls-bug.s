...
bge_else.373: #pc 656
	...
	j	print_int.173  #102 pc 672
	nop #pc 676
f.193:  #pc 680
	addi	%x6, %x6, 123  #209 pc 680
	ret #pc 684
	nop #pc 688
g.195:  #pc 692
	lw	%x6, 4(%x29)  #210 pc 692
	ret #pc 696
	nop #pc 700
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x3, 0  #209 pc 724
	addi	%x3, %x3, 4  #209 pc 728
	addi	%x7, %x0, 680  #209 f.193 pc 732
	sw	%x7, 0(%x6)  #209 pc 736
	addi	%x29, %x3, 0  #210 pc 740
	addi	%x3, %x3, 8  #210 pc 744
	addi	%x7, %x0, 692  #210 g.195 pc 748
	sw	%x7, 0(%x29)  #210 pc 752
	sw	%x6, 4(%x29)  #210 pc 756
	addi	%x6, %x0, 456  #0 pc 760
	sw	%x1, 0(%x2)  #211 pc 764
	lw	%x30, 0(%x29)  #211 pc 768
	addi	%x2, %x2, 4  #211 pc 772
	jalr	%x1, %x30, 0  #211 pc 776
	addi	%x2, %x2, -4  #211 pc 780
	lw	%x1, 0(%x2)  #211 pc 784
	addi	%x29, %x6, 0  #211 pc 788
	addi	%x6, %x0, 789  #0 pc 792
	sw	%x1, 0(%x2)  #211 pc 796
	lw	%x30, 0(%x29)  #211 pc 800
	addi	%x2, %x2, 4  #211 pc 804
	jalr	%x1, %x30, 0  #211 pc 808
	addi	%x2, %x2, -4  #211 pc 812
	lw	%x1, 0(%x2)  #211 pc 816
	sw	%x1, 0(%x2)  #211 pc 820
	addi	%x2, %x2, 4  #211 pc 824
	jal	%x1, print_int.173  #211 pc 828
	addi	%x2, %x2, -4  #211 pc 832
	lw	%x1, 0(%x2) #211 pc 836
