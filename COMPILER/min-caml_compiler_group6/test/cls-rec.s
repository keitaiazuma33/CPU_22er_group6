...
bge_else.373: #pc 648
	...
	nop #pc 668
f.195:  #pc 672
	lw	%x7, 4(%x29)  #0 pc 672
	beq	%x6, %x0, 12  #210 pc 676
	j	be_else.377 #pc 680
	nop #pc 684
	addi	%x6, %x0, 0  #0 pc 688
	ret #pc 692
	nop #pc 696
be_else.377: #pc 700
	addi	%x6, %x6, -1  #211 pc 700
	sw	%x7, 0(%x2)  #211 pc 704
	sw	%x1, 4(%x2)  #211 pc 708
	lw	%x30, 0(%x29)  #211 pc 712
	addi	%x2, %x2, 8  #211 pc 716
	jalr	%x1, %x30, 0  #211 pc 720
	addi	%x2, %x2, -8  #211 pc 724
	lw	%x1, 4(%x2)  #211 pc 728
	lw	%x7, 0(%x2)  #211 pc 732
	add	%x6, %x7, %x6  #211 pc 736
	ret #pc 740
	nop #pc 744
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 10  #0 pc 768
	addi	%x29, %x3, 0  #209 pc 772
	addi	%x3, %x3, 8  #209 pc 776
	addi	%x7, %x0, 672  #209 f.195 pc 780
