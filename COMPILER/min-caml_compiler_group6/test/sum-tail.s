...
bge_else.371: #pc 648
	...
	nop #pc 668
sum.195:  #pc 672
	bge	%x0, %x7, 12  #208 pc 672
	j	ble_else.375 #pc 676
	nop #pc 680
	ret #pc 684
	nop #pc 688
ble_else.375: #pc 692
	add	%x6, %x6, %x7  #209 pc 692
	addi	%x7, %x7, -1  #209 pc 696
	j	sum.195  #209 pc 700
	nop #pc 704
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 0  #0 pc 728
	addi	%x7, %x0, 10000  #0 pc 732
	sw	%x1, 0(%x2)  #210 pc 736
	addi	%x2, %x2, 4  #210 pc 740
	jal	%x1, sum.195  #210 pc 744
	addi	%x2, %x2, -4  #210 pc 748
	lw	%x1, 0(%x2) #210 pc 752
	sw	%x1, 0(%x2)  #210 pc 756
	addi	%x2, %x2, 4  #210 pc 760
	jal	%x1, print_int.175  #210 pc 764
	addi	%x2, %x2, -4  #210 pc 768
	lw	%x1, 0(%x2) #210 pc 772
