...
bge_else.371: #pc 656
	...
	nop #pc 676
sum.195:  #pc 680
	bge	%x0, %x7, 12  #208 pc 680
	j	ble_else.375 #pc 684
	nop #pc 688
	ret #pc 692
	nop #pc 696
ble_else.375: #pc 700
	add	%x6, %x6, %x7  #209 pc 700
	addi	%x7, %x7, -1  #209 pc 704
	j	sum.195  #209 pc 708
	nop #pc 712
...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 0  #0 pc 736
	addi	%x7, %x0, 10000  #0 pc 740
	sw	%x1, 0(%x2)  #210 pc 744
	addi	%x2, %x2, 4  #210 pc 748
	jal	%x1, sum.195  #210 pc 752
	addi	%x2, %x2, -4  #210 pc 756
	lw	%x1, 0(%x2) #210 pc 760
	sw	%x1, 0(%x2)  #210 pc 764
	addi	%x2, %x2, 4  #210 pc 768
	jal	%x1, print_int.175  #210 pc 772
	addi	%x2, %x2, -4  #210 pc 776
	lw	%x1, 0(%x2) #210 pc 780
