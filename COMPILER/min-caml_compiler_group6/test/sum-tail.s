...
min_caml_start:
	...
	addi	%x7, %x0, 10000  #0 pc 728
	sw	%x1, 0(%x2)  #210 pc 732
	addi	%x2, %x2, 4  #210 pc 736
	jal	%x1, sum.195  #210 pc 740
	addi	%x2, %x2, -4  #210 pc 744
	lw	%x1, 0(%x2) #210 pc 748
	sw	%x1, 0(%x2)  #210 pc 752
	addi	%x2, %x2, 4  #210 pc 756
	jal	%x1, print_int.175  #210 pc 760
	addi	%x2, %x2, -4  #210 pc 764
	lw	%x1, 0(%x2) #210 pc 768
