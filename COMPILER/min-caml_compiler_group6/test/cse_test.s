...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	addi	%x6, %x0, 6  #0 pc 700
	sw	%x1, 0(%x2)  #212 pc 704
	addi	%x2, %x2, 4  #212 pc 708
	jal	%x1, print_int.169  #212 pc 712
	addi	%x2, %x2, -4  #212 pc 716
	lw	%x1, 0(%x2) #212 pc 720
