...
min_caml_start:
	...
	slli	%x2, %x31, 24
	add	%x3, %x2, %x4
	sw	%x1, 0(%x2)  #210 pc 724
	addi	%x2, %x2, 4  #210 pc 728
	jal	%x1, f.196  #210 pc 732
	addi	%x2, %x2, -4  #210 pc 736
	lw	%x1, 0(%x2) #210 pc 740
	sw	%x6, 0(%x2)  #211 pc 744
	bge	%x0, %x6, 12  #211 pc 748
	j	ble_else.379 #pc 752
	nop #pc 756
	sw	%x1, 4(%x2)  #211 pc 760
	addi	%x2, %x2, 8  #211 pc 764
	jal	%x1, g.198  #211 pc 768
	addi	%x2, %x2, -8  #211 pc 772
	lw	%x1, 4(%x2) #211 pc 776
	lw	%x7, 0(%x2)  #211 pc 780
	add	%x6, %x6, %x7  #211 pc 784
	j	ble_cont.380 #pc 788
	nop #pc 792
ble_else.379: #pc 796
ble_cont.380: #pc 796
	lw	%x7, 0(%x2)  #211 pc 796
	add	%x6, %x6, %x7  #211 pc 800
	sw	%x1, 4(%x2)  #211 pc 804
	addi	%x2, %x2, 8  #211 pc 808
	jal	%x1, print_int.176  #211 pc 812
	addi	%x2, %x2, -8  #211 pc 816
	lw	%x1, 4(%x2) #211 pc 820
